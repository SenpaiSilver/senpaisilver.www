...
<html>
	...
	<body>
		...
		<div class="material-mainpage">
			<h1>Projects</h1>
			<ul class="cards">
				<li class="card artifacthunter"><a href="https://github.com/SenpaiSilver/ArtifactHunter"><span>ArtifactHunter</span></a></li>
				<li class="card fov"><a href="https://github.com/SenpaiSilver/FOVComparator"><span>FOVComparator</span></a></li>
			</ul>
		</div>
	</body>
</html>
